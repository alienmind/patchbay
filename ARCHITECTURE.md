...
chain-select layout in `TEMPLATE_SPEC.md` gets driven from a macro.
...
## 11. Practical rules for generators
...
| **[?]** | `MacroVariations` contents — empty in every current sample. | S8 | Phase 5 |
