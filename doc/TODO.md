...
|---|---|---|---|---|
| 1 | Drag `build/PATCHBAYGROUND.als` into Live, attempt 8 | you | 1 drag | Whether the written Set loads: 8 tracks, 6 returns, 52 racks placed, all routing written |
...
| 7 | nothing. `EXCEPTION_ACCESS_VIOLATION` again | `LiveSet/SendsPre` held the skeleton's 2 flags against 6 returns. Q38 |
| 8 | unrun | |
